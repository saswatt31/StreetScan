      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <Button
            variant="outline"
            size="lg"
            className="rounded-full px-8 h-12 text-base font-medium border-border text-foreground hover:bg-muted bg-transparent"
          >
            View Demo
          </Button>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm text-muted-foreground">
            Trusted by <span className="text-foreground font-medium">2,000+</span> teams worldwide
          </p>
        </motion.div>
      </div>
    </section>
